...
const AdminOverviewgenderShop = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await axios.post('https://apifordropment.online/api/orders/overview/shop/gender', { shopId });
  ...
  return (
    <div style={{ backgroundColor: '#171A2D', padding: '20px', borderRadius: '8px', width: '200px', height: '300px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)' }}>
...
export default AdminOverviewgenderShop;
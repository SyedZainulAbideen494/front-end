...
const Section12BuildEditSec5 = () => {
  ...
  <Addimage3/>
    ...
    return<Fragment>
      <EditMenu/>
      <div className="section12-main-div" style={{backgroundColor: backgroundColor1}}>
        ...
        <div className="section12-middle-part">
          <div className="section12-middle-parts-top-key" style={{backgroundColor: backgroundColor2}}>
            <h1 style={{color: fontColor3}}>What we do</h1>
            <p style={{color: fontColor4}}>We provide saas services to customer who want to expmnd their business online</p>
          </div>
          <div className="section12-middle-parts-bottom-key" style={{backgroundColor: backgroundColor3}}>
          <h1 style={{color: fontColor5}}>What we do</h1>
            <p style={{color: fontColor6}}>We provide saas services to customer who want to expmnd their business online</p>
          </div>
        </div>
        <div className="section12-right-part"></div>
      </div>
    </Fragment>
}

export default Section12BuildEditSec5
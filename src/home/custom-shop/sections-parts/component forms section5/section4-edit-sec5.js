...
import Axios from 'axios'; // Import Axios from 'axios' instead of "{ Axios } from 'axios'".
  ...
  const EditMenu = () => {
    ...
    function Productsinshopapp() {
        ...
        const fetchProductsHandler = useCallback(async () => {
          ...
          try {
            const response = await fetch("https://apifordropment.online/section/4/new/arrivals", {
              headers: {
                Authorization: params.shop_id,
              },
            });
            ...
            <div className="section-4-build-main-div-prods">
                <li>
                  ...
                  <div className="section-3-build-prods-details">
                    <p style={{color: fontColor2}}>Title</p>
                  <h3 style={{color: fontColor3}}>$434</h3>
                  </div>
                </li>
                <li>
                  <div className="section-3-build-products-img">
...
export default Section4BuildEditSec5
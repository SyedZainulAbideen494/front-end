    ...
    <Fragment>
      ...
      <div className="section1-buildleft">
        ...
        <section className="section1buildlefttext">
          <h2  style={{color: fontColor3}}>{items[0]?.shop_blockhead2 || "Header"}</h2>
          <p  style={{color: fontColor4}}>{items[0]?.shop_block2 || "The sun cast a warm glow over the serene meadow as a gentle breeze rustled the wildflowers. Birds sang melodies from the treetops, creating a symphony of nature. Nearby, a babbling brook sparkled under the midday sun, inviting anyone to dip their feet in and embrace the tranquility of the moment."}</p>
        </section>
      </div>
      <div className="section1-buildright">
        <section className="section1buildrighttext">
          <h2 style={{color: fontColor5}}>{items[0]?.shop_blockhead3 || "Header"}</h2>
          <p style={{color: fontColor6}}>{items[0]?.shop_block3 || "The sun cast a warm glow over the serene meadow as a gentle breeze rustled the wildflowers. Birds sang melodies from the treetops, creating a symphony of nature. Nearby, a babbling brook sparkled under the midday sun, inviting anyone to dip their feet in and embrace the tranquility of the moment."}</p>
        </section>
        <section className="imgrightsection1build">
          <img src={img1} alt="Image" /> {/* Added alt attribute for the image */}
        </section>
...
export default Section1BuildEditSec5;
...
const Section9Buildpreview = () => {
    ...
    return<Fragment>
       <div className="section-9-build-main-div">
        <div className="section-9-build-section1">
            <section>
                <h1>heading</h1>
                <p>The serene forest enveloped in an emerald cloak
        ...
        <div className="section-9-build-section2">
            <section>
                <h1>heading</h1>
                <p>The serene forest enveloped in an emerald cloak
                    whispered secrets to the breeze. Birds sang
...
export default Section9Buildpreview
...
const Section1BuildSec4 = () => {
    ...
    const fetctimgHandler = useCallback(async () => {
      ...
      const transformedItems = data.shops.map((itemsdata) => {
        return {
          images2: `https://apifordropment.online/images/${itemsdata.images4}`,
          images3: `https://apifordropment.online/images/${itemsdata.images5}`,
          images4: `https://apifordropment.online/images/${itemsdata.images6}`
        };
      });
...
export default Section1BuildSec4
...
const Section1BuildSec4 = () => {
    ...
    const fetctimgHandler = useCallback(async () => {
      ...
      const transformedItems = data.shops.map((itemsdata) => {
        return {
          images2: `http://localhost:8080/images/${itemsdata.images4}`,
          images3: `http://localhost:8080/images/${itemsdata.images5}`,
          images4: `http://localhost:8080/images/${itemsdata.images6}`
        };
      });

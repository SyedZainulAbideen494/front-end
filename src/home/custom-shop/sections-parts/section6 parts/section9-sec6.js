  ...
  useEffect(() => {
    ...
    return<Fragment>
       <div className="section-9-build-main-div">
        <div className="section-9-build-section1" style={{backgroundColor: color[0]?.background_colour1}}>
            <section>
        ...
        <div className="section-9-build-section2" style={{backgroundColor: color[0]?.background_colour2}}>
            <section>
                <h1 style={{color: color[0]?.font_colour3}}>{items[0]?.shop_blockhead2}</h1>
                <p style={{color: color[0]?.font_colour4}}>{items[0]?.shop_block2}</p>
                   
            </section>
        </div>
        <div className="section-9-build-section1" style={{backgroundColor: color[0]?.background_colour3}}>
            <section>
                <h1 style={{color: color[0]?.font_colour5}}>{items[0]?.shop_blockhead3}</h1>
...
export default Section9BuildSec6
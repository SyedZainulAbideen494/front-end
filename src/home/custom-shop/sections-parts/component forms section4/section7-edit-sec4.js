      ...
      <EditMenu/>
       <div className="section-7-build-main-div-preview">
        <section className="section-7-build-section-preview">
            <h1 style={{color: fontColor1}}>Winter sales 25% off</h1>
            <button style={{border: `2px solid ${backgroundColor1}`, color: fontColor2}}>Shop Now</button>
        </section>
       </div>
    </Fragment>
}

export default Section7BuildEditSec4
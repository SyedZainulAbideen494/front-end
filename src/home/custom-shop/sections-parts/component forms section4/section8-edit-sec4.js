    ...
    function Productsinshopapp() {
      ...
      const DummyProducts = () => {
        return (
          ...
          <li className="main-main-div-prods-section-8-build" style={{backgroundColor: backgroundColor1}}>
            ...
            <div className="section-8-build-prods-details">
              ...
              <button style={{color: fontColor5, border: `2px solid ${backgroundColor2}`, backgroundColor: backgroundColor3}}>Buy Now</button>
            </div>
          </li>
          <li className="main-main-div-prods-section-8-build" style={{backgroundColor: backgroundColor1}}>
            <div className="section-8-build-products-img">
    ...
    return<Fragment>
        ...
        <div className="main-div-section-5-build">
            <div className="section-5-build-txt-top">
                ...
                <p style={{color: fontColor2}}>View from our latest collection</p>
            </div>
            <DummyProducts/>
        </div>
    </Fragment>
...
export default Section8BuildEditSec4
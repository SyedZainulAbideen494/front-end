  ...
  const EditMenu = () => {
    ...
    const handleFontColorChange6 = (event) => {
      setfontColor6(event.target.value);
       ...
       const NextStep = () => {
        window.location.href = `/build/${params.build}/preview/${params.shop_id}/${params.build}/${params.build}`;
    };
...
export default Section10BuildEditSec4
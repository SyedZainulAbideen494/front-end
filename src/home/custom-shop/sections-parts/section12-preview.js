...
const Section12Buildpreview = () => {
    ...
    return<Fragment>
      <div className="section12-main-div">
        ...
        <div className="section12-middle-part">
          <div className="section12-middle-parts-top-key">
            <h1>What we do</h1>
            <p>We provide saas services to customer who want to expmnd their business online</p>
          </div>
...
export default Section12Buildpreview
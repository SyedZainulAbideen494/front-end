    ...
    return<Fragment>
      <EditMenu/>
        <div className="section2-buildright-preview">
          <div className="section1-section-1build-preview" style={{backgroundColor: backgroundColor1}}>
            <section className="section1-section-1build-text-preview">
                <h2 style={{color: fontColor1}}>{items[0]?.shop_blockhead1 || "Text 1"}</h2>
                <p style={{color: fontColor2}}>{items[0]?.shop_block1 || "Text 2"}</p>
            </section>
            <section className="section1-section-1build-image-preview"></section>
          </div>
          <div className="section2-section-1build-preview" style={{backgroundColor: backgroundColor2}}>         
            <section className="section2-section-1build-text-preview">
                <h2 style={{color: fontColor3}}>{items[0]?.shop_blockhead2 || "Text 3"}</h2>
                <p style={{color: fontColor4}}>{items[0]?.shop_block2 || "Text 4"}</p>
            </section>
            <section className="section2-section-1build-image-preview"></section>
          </div>
          <div className="section3-section-1build-preview" style={{backgroundColor: backgroundColor3}}>
            <section className="section3-section-1build-text-preview">
                <h2 style={{color: fontColor5}}>{items[0]?.shop_blockhead3 || "Text 5"}</h2>
                <p style={{color: fontColor6}}>{items[0]?.shop_block3 || "Text 6"}</p>
            </section>
...
export default Section2BuildEditSec6
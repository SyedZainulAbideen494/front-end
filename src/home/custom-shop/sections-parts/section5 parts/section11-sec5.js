      ...
      const Products = (props) => {
        ...
        return (
          <div className="section-11-build-main-div-prods">
            {name.map((user, index) => (
              <li key={index} className="main-main-div-prods-section-11-build" style={{backgroundColor: color[0]?.background_colour1}}>
                ...
                <div className="section-11-build-prods-details">
                  <p style={{color: color[0]?.font_colour1}}>{props.title}</p>
                <button style={{backgroundColor: color[0]?.background_color2, border:`1px solid ${color[0]?.background_colour2}`, color: color[0]?.font_colour2}}><Pricing country={user.country} /> Buy now</button>
                </div>
              </li>
            ))}
          </div>
...
export default Section11BuildSec5
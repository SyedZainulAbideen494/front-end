...
function NavBar7Edit() {
  ...
  const EditMenu = () => {
    ...
    return (
      ...
      <div className="color-palette">
          <label htmlFor="bgclr3"><h4>background color 4</h4></label>
        <input
          type="color"
  ...
  return (
    <Fragment>
      ...
      <header className='nav-bar-7' style={{backgroundColor: backgroundColor1}}>
        ...
        <section className='section2-nav-bar-7'>
            <button style={{backgroundColor: backgroundColor2, border: `2px solid ${backgroundColor3}`, color: fontColor2}}>{items[0]?.button1 || 'Button 1'}</button>
        ...
        <section className='section3-nav-bar-7'>
            <button onClick={handleWhatsAppClick} style={{backgroundColor: backgroundColor4, border: `2ps solid ${backgroundColor4}`, color: fontColor3}}>Contact us</button>
        </section>
      </header>
    </div>
    </Fragment>

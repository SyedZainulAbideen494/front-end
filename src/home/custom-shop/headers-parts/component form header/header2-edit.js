  ...
  return (
    <Fragment>
      ...
      <div className="hero-content-2-preview">
        <h1 className="hero-title-2-preview" style={{color: fontColor1}}>Welcome to Our Website</h1>
        <p className="hero-subtitle-2-preview" style={{color: fontColor2}}>Discover amazing things here.</p>
        <button className="cta-button-2-preview" style={{backgroundColor: backgroundColor1, border:`2px solid ${backgroundColor2}`, color: fontColor3}}>Get Started</button>
      </div>
    </div>
    </Fragment>
  );

...
const Header4Edit = () => {
  ...
  return (
    ...
    <div className="hero-section-4-preview">
      <p className="header4-hero-tagline-preview" style={{color: fontColor1}}>Discover the Best Deals</p>
      <div className="sales-offer-header4-preview">
        <p className="header4-hero-sales-discount-preview" style={{color: fontColor2}}>Winter Sale 25% Off</p>
      </div>
      <div className="cta-buttons">
        <button className="header4-shop-button-preview" style={{backgroundColor: backgroundColor1, color: fontColor3, border:`2px solid ${backgroundColor2}`}}>Shop Now</button>
        <button className="header4-learn-button-preview" style={{backgroundColor: backgroundColor1, color: fontColor3, border:`2px solid ${backgroundColor2}`}}>Learn More</button>
      </div>
    </div>
    </Fragment>
  );
